    ...
    <div class="box box-primary" 
        ...
        <div class="box-header">
            ...
            <div class="box-tools pull-right row-color-picker">
                <el-color-picker v-model="widgetBackground"
                                 @active-change="handleAcitveColorChange"
                                 @change="handleColorChange"
                                 class="btn btn-box-tool"></el-color-picker>
...
export default {
  ...
  methods: {
    ...
    handleAcitveColorChange(color) {
      this.widgetBackground = color;
    },
    handleColorChange(color) {
      this.widget.background = color;
    }
  }
}
</script>
